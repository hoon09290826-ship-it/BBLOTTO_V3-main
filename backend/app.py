...
RC_VERSION = 'STABLE5_RUNTIME_SAFETY'
...
def ui_health():
    return {'ok': True, 'version': 'STABLE-5', 'event_owner': 'app.js', 'fallback_file': 'critical-buttons.js', 'fallback_only_when_bindings_missing': True}
